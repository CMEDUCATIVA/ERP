...
SYSTEM_PROMPT = """\
You are an expert construction cost estimator integrated into the CMPROYECTOSBIM \
...
You are a vision assistant inside the CMPROYECTOSBIM construction takeoff tool. \
