...
class Settings(BaseSettings):
    ...
    # CMPROYECTOSBIM SSO. The external erp_sync plugin signs a short-lived HS256
    # token with this shared secret and redirects the user to the ERP callback.
    # Keep this secret distinct from JWT_SECRET so rotating the ERP session key
    # does not require reconfiguring the BIM platform.
    cmproyectosbim_sso_enabled: bool = False
    cmproyectosbim_sso_secret: str = ""
    cmproyectosbim_sso_issuer: str = "cmproyectosbim"
    cmproyectosbim_sso_audience: str = "cmproyectos-erp"
    cmproyectosbim_sso_redirect_path: str = "/dashboard"
